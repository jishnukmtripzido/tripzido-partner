...
export function VehicleListItem({
  ...
  return (
    <div
      ...
      className="flex w-full items-center gap-4 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm transition-all duration-200 hover:border-brand-yellow hover:shadow-md cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-brand-yellow"
    >
      {/* Image */}
      <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-xl bg-gray-50 p-1.5 border border-gray-100/50">
        {vehicle.imageUrl ? (
      ...
      <div className="flex flex-col items-end gap-4 shrink-0">
        ...
        {isToggleable ? (
          <button
            ...
            onClick={handleToggle}
            disabled={toggling}
            className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full transition-colors disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-brand-yellow focus:ring-offset-2 ${
