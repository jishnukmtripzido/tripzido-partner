  ...
  return (
    <div className="flex items-center gap-3 bg-gray-50 p-1 rounded-lg border border-gray-100 shadow-inner">
      ...
      <button
        ...
        className="w-7 h-7 rounded bg-brand-yellow text-brand-secondary shadow-sm flex items-center justify-center transition-colors border border-brand-yellow"
      >
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
