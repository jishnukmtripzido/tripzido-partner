...
export function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <aside
        className={`drawer-panel drawer-panel-${phase} absolute left-0 top-0 bottom-0 w-[82%] max-w-xs bg-white shadow-sm flex flex-col pt-safe`}
      >
        <div className="px-5 pt-6 pb-5 border-b border-gray-100">
          <div className="flex items-center justify-between mb-5">
            ...
            <button
              ...
              className="p-1.5 -m-1.5 text-gray-400 hover:text-font-main-sub transition-colors"
            >
              <svg
                className="w-6 h-6"
                fill="none"
