...
//  * modifies BottomNav or the hamburger drawer Sidebar, both of which
//  * keep working below lg: exactly as before.
//  */
...
//   return (
//     <aside className="hidden lg:flex lg:flex-col w-64 shrink-0 border-r border-gray-100 bg-white h-dvh">
